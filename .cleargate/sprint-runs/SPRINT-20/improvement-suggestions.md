# Improvement Suggestions — SPRINT-20


## Trends

Trends: 9 closed sprints visible — full analysis deferred to CR-027.

## Skill Creation Candidates

<!-- generated-by: suggest_improvements.mjs --skill-candidates -->

### CAND-SPRINT-20-S01: STORY-020-02 × architect
<!-- hash:f55a32 -->
...
### CAND-SPRINT-20-F01: Tests that grep CLAUDE.md must be updated in the same commit
<!-- hash:97b920 -->
...
### CAND-SPRINT-20-F02: STORY-026-02 R7 ≥60-line target became unreachable after Wav
<!-- hash:a80635 -->
...
### CAND-SPRINT-20-F03: CR-028: template numbered headings (## 3.5, ### 1.6) don't m
<!-- hash:d22224 -->
...
### CAND-SPRINT-20-F04: CR-028 SPRINT-20 anchor backfill = 6 anchors get sections (E
<!-- hash:c720c5 -->
...
### CAND-SPRINT-20-F05: CR-028 inserted unnumbered "Code-Truth Principle" preamble B
<!-- hash:42a713 -->
...
### CAND-SPRINT-20-F06: CR-028: code-truth principle stack — wiki/memory/context_sou
<!-- hash:96b1dd -->
...
### CAND-SPRINT-20-F07: readCachedGate is async; sprint preflight is sync — CR-027 i
<!-- hash:8ca144 -->
...
### CAND-SPRINT-20-F08: assert_story_files.mjs gained --emit-json flag (CR-027 path-
<!-- hash:5c8281 -->
...
### CAND-SPRINT-20-F09: backfill_hierarchy.mjs spliceKeys inserted NEW line for exis
<!-- hash:c18ec7 -->
...
### CAND-SPRINT-20-F10: M-plan-spec'd integration test files are REQUIRED, not optio
<!-- hash:0df16d -->
...
### CAND-SPRINT-20-F11: token-ledger.sh has a copy-on-fix snapshot lock in test/snap
<!-- hash:f04670 -->
...
### CAND-SPRINT-20-F12: token-ledger.sh transcript-grep fallback skips ^[0-9]+ items
<!-- hash:adfa5e -->
...
### CAND-SPRINT-20-F13: PreToolUse:Task hook auto-writes dispatch marker by grepping
<!-- hash:21d78b -->
...
### CAND-SPRINT-20-F14: token-ledger.sh uses newest-file lookup (ls -t .dispatch-*.j
<!-- hash:39def5 -->
...
### CAND-SPRINT-20-F15: session-start.sh snapshot locks (cr-008/cr-009) must be upda
<!-- hash:746039 -->
...
### CAND-SPRINT-20-F16: Dev agent's `git commit` landed on `main` instead of `story/
<!-- hash:8c121a -->
...
### CAND-SPRINT-20-F17: vitest maxForks cap is PER-PROCESS — N parallel agents × max
<!-- hash:560649 -->
...
### CAND-SPRINT-20-F18: Cap forks pool via vitest.config.ts `poolOptions.forks.maxFo
<!-- hash:8c1f83 -->
...
### CAND-SPRINT-20-F19: `cleargate story start <id>` requires CLEARGATE_STATE_FILE e
<!-- hash:f33efe -->
...
### CAND-SPRINT-20-F20: cleargate-cli/templates/cleargate-planning/ is DERIVED — cop
<!-- hash:c25e90 -->
...
### CAND-SPRINT-20-F21: vitest spawns 5–9 tinypool workers (~4GB each) that survive 
<!-- hash:69c9b7 -->
...
### CAND-SPRINT-20-F22: CLAUDE.md live↔canonical pre-divergent by 4 canonical-only b
<!-- hash:d42a68 -->
...
### CAND-SPRINT-20-F23: `cleargate-planning/MANIFEST.json` SHAs change after every p
<!-- hash:0f1e04 -->
...
### CAND-SPRINT-20-F24: DoD §4.2 specifies `feat(<epic>):` but Developers default to
<!-- hash:9d6184 -->
...
### CAND-SPRINT-20-F25: Sprint frontmatter `start_date` is the *planned* date — for 
<!-- hash:c070f1 -->
...
### CAND-SPRINT-20-F26: `protocol-section-N.test.ts` files reference numeric §-IDs t
<!-- hash:efb34c -->
...
### CAND-SPRINT-20-F27: `cleargate wiki lint` exits 1 even for pre-existing findings
<!-- hash:f59c44 -->
...
### CAND-SPRINT-20-F28: M2 citation-rewrite surface omitted `.cleargate/templates/` 
<!-- hash:201390 -->
...
### CAND-SPRINT-20-F29: `git worktree remove --force --force` does NOT kill detached
<!-- hash:0752a2 -->
...
### CAND-SPRINT-20-F30: import.meta.url in vitest source-mode resolves to src/comman
<!-- hash:17b1b6 -->
...
### CAND-SPRINT-20-F31: CLEARGATE_NO_UPDATE_CHECK=1 suppresses all checkLatestVersio
<!-- hash:afbb1f -->
...
### CAND-SPRINT-20-F32: worktrees share no node_modules with parent; run `npm ci --w
<!-- hash:cb754b -->
...
### CAND-SPRINT-20-F33: Story bodies authored at SPRINT-N draft time freeze the pack
<!-- hash:67e7b6 -->
...
### CAND-SPRINT-20-F34: cleargate-cli/CHANGELOG.md exists pre-EPIC-016 in non-Common
<!-- hash:02c34b -->
...
### CAND-SPRINT-20-F35: MCP tool requests must NOT carry project_id in the body — JW
<!-- hash:a2932f -->
...
### CAND-SPRINT-20-F36: CLI sha = sha256(body + serializeFrontmatter(fm)) where seri
<!-- hash:aa1c13 -->
...
### CAND-SPRINT-20-F37: cleargate-cli/src/commands/sync.ts already exists (718 LOC, 
<!-- hash:0fcb8f -->
...
### CAND-SPRINT-20-F38: checkPaginationNeeded MAX_BUCKET_ENTRIES=50 is hardcoded; fi
<!-- hash:088f12 -->
...
### CAND-SPRINT-20-F39: wiki build reads children: from raw EPIC/SPRINT files (not i
<!-- hash:4d93b6 -->
...
### CAND-SPRINT-20-F40: BUG-018 missed the no-force-skip branch; every skip branch t
<!-- hash:95a4c1 -->
...
### CAND-SPRINT-20-F41: token-ledger.sh role-grep loop is hard-coded at line 172; ne
<!-- hash:076cff -->
...
### CAND-SPRINT-20-F42: assert_story_files.mjs covers all six id shapes (STORY/CR/BU
<!-- hash:949850 -->
...
### CAND-SPRINT-20-F43: update_state.mjs has no module guard — `import { fn } from '
<!-- hash:6a8af4 -->
...
### CAND-SPRINT-20-F44: In bash hook, `DOCTOR_EXIT=$?` after `$(cmd || true)` always
<!-- hash:5af18e -->
...
### CAND-SPRINT-20-F45: Hook resolver tail-branch must never be `exit 0` — use `npx 
<!-- hash:330eae -->
...
### CAND-SPRINT-20-F46: readline.createInterface buffers ahead — when two readline i
<!-- hash:2c1efc -->
...
### CAND-SPRINT-20-F47: `identity_proofs.challenge_payload` jsonb is provider-privat
<!-- hash:6cc59b -->
...
### CAND-SPRINT-20-F48: mcp/.env.example documents env vars (e.g. CLEARGATE_RESEND_*
<!-- hash:98add2 -->
...
### CAND-SPRINT-20-F49: worktree npm ci needed for typecheck — node_modules not shar
<!-- hash:20ab4e -->
...
### CAND-SPRINT-20-F50: wiki command tests live at `cleargate-cli/test/wiki/<cmd>.te
<!-- hash:61fc66 -->
...
### CAND-SPRINT-20-F51: sprint/epic/proposal discrimination is via filename prefix t
<!-- hash:6a5501 -->
...
### CAND-SPRINT-20-F52: vitest JSON via --outputFile beats stdout parsing — subproce
<!-- hash:32006b -->
...
### CAND-SPRINT-20-F53: `cleargate sprint close` CLI handler doesn't pass through `-
<!-- hash:893004 -->
...
### CAND-SPRINT-20-F54: `cleargate state update <STORY> <state>` with no --sprint co
<!-- hash:9b3934 -->
...
### CAND-SPRINT-20-F55: close_sprint/suggest_improvements/prefill_report resolve spr
<!-- hash:bb43b2 -->
...
### CAND-SPRINT-20-F56: Admin Dockerfile must force ENV NODE_ENV=development in buil
<!-- hash:74cbf0 -->
...
### CAND-SPRINT-20-F57: status-of([[ID]]) requires a literal ID — cannot dynamically
<!-- hash:549fdc -->
...
### CAND-SPRINT-20-F58: Rate-limit integration tests for public routes must use a de
<!-- hash:6bdfd6 -->
...
### CAND-SPRINT-20-F59: [R] superseded-by BUG-001-fix · parseFrontmatter must use js
<!-- hash:dc7a29 -->
...
### CAND-SPRINT-20-F60: parallel Developer agents on main share a working tree — one
<!-- hash:dc0a3c -->
...
### CAND-SPRINT-20-F61: [R] superseded-by BUG-001-fix · parseFrontmatter stores nest
<!-- hash:5d3cad -->
...
### CAND-SPRINT-20-F62: init.ts has its own HOOK_ADDITION constant (SPRINT-04 legacy
<!-- hash:5771d2 -->
...
### CAND-SPRINT-20-F63: ManifestEntry.overwrite_policy uses 'skip' not 'never'; stor
<!-- hash:4a7b7d -->
...
### CAND-SPRINT-20-F64: gate check infers transition from cached_gate_result.pass: n
<!-- hash:92b4d1 -->
...
### CAND-SPRINT-20-F65: readiness-gates.md fenced yaml blocks are YAML lists (- work
<!-- hash:c45bf0 -->
...
### CAND-SPRINT-20-F66: section evaluator split on /^(?=## )/m: if body starts with 
<!-- hash:70a9e2 -->
...
### CAND-SPRINT-20-F67: token-ledger.sh routes via `ls -td sprint-runs/*/` and tags 
<!-- hash:f25585 -->
...
### CAND-SPRINT-20-F68: CLAUDE.md bounded-block regex must be GREEDY (`[\s\S]*` not 
<!-- hash:c5c953 -->
...
### CAND-SPRINT-20-F69: open-gates.ts filter `status.includes('🔴')` matches zero it
<!-- hash:5677bc -->
...
### CAND-SPRINT-20-F70: When story body and subagent def disagree on a CLI flag (e.g
<!-- hash:5092e6 -->
...
### CAND-SPRINT-20-F71: Wiki commands (build/ingest) need a `now` test seam to freez
<!-- hash:32caf7 -->
...
### CAND-SPRINT-20-F72: Wiki subagent defs MUST embed exact YAML page-schema templat
<!-- hash:706237 -->
...
### CAND-SPRINT-20-F73: Claude Code hooks schema: PostToolUse uses nested `hooks[]` 
<!-- hash:4eb224 -->
...
### CAND-SPRINT-20-F74: `cleargate join` UUID-first-check pattern: test UUID_V4_RE b
<!-- hash:edbc2e -->
...
### CAND-SPRINT-20-F75: For malformed-UUID path params, validate with regex before D
<!-- hash:f85168 -->
...
### CAND-SPRINT-20-F76: vi.mock() is hoisted to top of file; variables used in facto
<!-- hash:b1fd68 -->
...
### CAND-SPRINT-20-F77: When vendoring response schemas in a CLI from a server's han
<!-- hash:4d4efa -->
...
### CAND-SPRINT-20-F78: Admin JWT file ~/.cleargate/admin-auth.json is a single-toke
<!-- hash:3be8f5 -->
...
### CAND-SPRINT-20-F79: vi.mock('@napi-rs/keyring') replaces module before native bi
<!-- hash:92a0bf -->
...
### CAND-SPRINT-20-F80: @napi-rs/keyring Entry.getPassword() returns string | null (
<!-- hash:683f9f -->
...
### CAND-SPRINT-20-F81: fs.writeFile(path, data, {mode}) only sets mode on creation;
<!-- hash:183c0d -->
