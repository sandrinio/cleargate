# Improvement Suggestions — SPRINT-23


## Trends

Trends: 12 closed sprints visible — full analysis deferred to CR-027.

## Skill Creation Candidates

<!-- generated-by: suggest_improvements.mjs --skill-candidates -->

### CAND-SPRINT-23-S01: CR-045 × architect
<!-- hash:6b1802 -->
...
### CAND-SPRINT-23-F01: preflight Step 0 always re-stamps last_gate_check → self-ind
<!-- hash:e0785a -->

**Category:** resolved
**Reason:** keyword found in a prior §6 Tooling section
**Original entry:** `2026-05-04 · #preflight #sprint-kickoff #gate-stamp · preflight Step 0 always re-stamps last_gate_check → self-induced dirty-main on same run; commit refresh, proceed without re-running.`
**Suggested action:** approve to remove via `cleargate flashcard prune` (run /improve)

---

### CAND-SPRINT-23-F02: token-ledger.sh snapshot-lock supersede pattern: cr-NNN.sh b
<!-- hash:b7290d -->
...
### CAND-SPRINT-23-F03: token-ledger.sh primary dispatch-marker path (L121-141) alre
<!-- hash:dd3120 -->
...
### CAND-SPRINT-23-F04: Sample/example test fixtures live in `cleargate-cli/examples
<!-- hash:559ed8 -->
...
### CAND-SPRINT-23-F05: Red+node combined naming: `*.red.node.test.ts` (red BEFORE n
<!-- hash:8a39c1 -->
...
### CAND-SPRINT-23-F06: SKILL.md §C insert + renumber: forward-only handoff (§C.N fo
<!-- hash:ad69f2 -->
...
### CAND-SPRINT-23-F07: `.claude/hooks/pre-commit-surface-gate.sh` is an 11-line stu
<!-- hash:828c81 -->
...
### CAND-SPRINT-23-F08: NODE_TEST_CONTEXT=child-v8 causes nested tsx --test invocati
<!-- hash:871c6a -->
...
### CAND-SPRINT-23-F09: reporter.md L108 claim "Task tool creates new conversation p
<!-- hash:92fe0a -->
...
### CAND-SPRINT-23-F10: Claude Code Agent/Task tool shares orchestrator session_id —
<!-- hash:b0c159 -->
...
### CAND-SPRINT-23-F11: close_sprint.mjs Step 3.5 is v2-fatal post-CR-036 — bundle ≥
<!-- hash:0e38f8 -->
...
### CAND-SPRINT-23-F12: Reporter token budget: 200k soft warn / 500k hard advisory +
<!-- hash:3b2855 -->
...
### CAND-SPRINT-23-F13: Reporter dispatched in fresh session via write_dispatch.sh s
<!-- hash:506e66 -->
...
### CAND-SPRINT-23-F14: Architect plan said close_sprint.mjs is live-only; canonical
<!-- hash:a8602c -->
...
### CAND-SPRINT-23-F15: Dev's "pre-existing failure count" can be FILE count not TES
<!-- hash:905de2 -->
...
### CAND-SPRINT-23-F16: gate.ts or_group?: optional field on GateCriterion — criteri
<!-- hash:e27323 -->
...
### CAND-SPRINT-23-F17: stamp-tokens.ts L194 idKeys array + work-item-type.ts L14 FM
<!-- hash:e33e80 -->
...
### CAND-SPRINT-23-F18: .session-totals.json is UUID-keyed map not flat — sum Object
<!-- hash:941303 -->
...
### CAND-SPRINT-23-F19: cleargate-planning/.cleargate/scripts/ does NOT mirror prep_
<!-- hash:12203d -->
...
### CAND-SPRINT-23-F20: Live `.claude/agents/` is gitignored — canonical edits to ag
<!-- hash:7deaf6 -->
...
### CAND-SPRINT-23-F21: BUG filed against npm-published version may already be fixed
<!-- hash:7364f9 -->
...
### CAND-SPRINT-23-F22: CR-034: spec §4.2 ≤2 listed-item count contradicted §3 6-cri
<!-- hash:e82929 -->
...
### CAND-SPRINT-23-F23: SPRINT-21 cached_gate_result.pass hand-set true (engine can'
<!-- hash:269aeb -->
...
### CAND-SPRINT-23-F24: Tests that grep CLAUDE.md must be updated in the same commit
<!-- hash:97b920 -->
...
### CAND-SPRINT-23-F25: CR-028: template numbered headings (## 3.5, ### 1.6) don't m
<!-- hash:d22224 -->
...
### CAND-SPRINT-23-F26: CR-028 SPRINT-20 anchor backfill = 6 anchors get sections (E
<!-- hash:c720c5 -->
...
### CAND-SPRINT-23-F27: CR-028 inserted unnumbered "Code-Truth Principle" preamble B
<!-- hash:42a713 -->
...
### CAND-SPRINT-23-F28: CR-028: code-truth principle stack — wiki/memory/context_sou
<!-- hash:96b1dd -->
...
### CAND-SPRINT-23-F29: CR-027 §4.7: Scenario 14 tests null-gate-result, not risk-ta
<!-- hash:e434b0 -->
...
### CAND-SPRINT-23-F30: CR-027: sprint preflight gained check #5 (per-item cached_ga
<!-- hash:7bd308 -->
...
### CAND-SPRINT-23-F31: assert_story_files.mjs gained --emit-json flag (CR-027 path-
<!-- hash:5c8281 -->
...
### CAND-SPRINT-23-F32: SDR may name wrong suspect if grep-based; dev bisection can 
<!-- hash:2ab149 -->
...
### CAND-SPRINT-23-F33: backfill_hierarchy.mjs spliceKeys inserted NEW line for exis
<!-- hash:c18ec7 -->
...
### CAND-SPRINT-23-F34: M-plan-spec'd integration test files are REQUIRED, not optio
<!-- hash:0df16d -->
...
### CAND-SPRINT-23-F35: token-ledger.sh has a copy-on-fix snapshot lock in test/snap
<!-- hash:f04670 -->
...
### CAND-SPRINT-23-F36: token-ledger.sh transcript-grep fallback skips ^[0-9]+ items
<!-- hash:adfa5e -->
...
### CAND-SPRINT-23-F37: PreToolUse:Task hook auto-writes dispatch marker by grepping
<!-- hash:21d78b -->
...
### CAND-SPRINT-23-F38: token-ledger.sh uses newest-file lookup (ls -t .dispatch-*.j
<!-- hash:39def5 -->
...
### CAND-SPRINT-23-F39: session-start.sh snapshot locks (cr-008/cr-009) must be upda
<!-- hash:746039 -->
...
### CAND-SPRINT-23-F40: Dev agent's `git commit` landed on `main` instead of `story/
<!-- hash:8c121a -->
...
### CAND-SPRINT-23-F41: vitest maxForks cap is PER-PROCESS — N parallel agents × max
<!-- hash:560649 -->
...
### CAND-SPRINT-23-F42: Cap forks pool via vitest.config.ts `poolOptions.forks.maxFo
<!-- hash:8c1f83 -->
...
### CAND-SPRINT-23-F43: `cleargate story start <id>` requires CLEARGATE_STATE_FILE e
<!-- hash:f33efe -->
...
### CAND-SPRINT-23-F44: cleargate-cli/templates/cleargate-planning/ is DERIVED — cop
<!-- hash:c25e90 -->
...
### CAND-SPRINT-23-F45: vitest spawns 5–9 tinypool workers (~4GB each) that survive 
<!-- hash:69c9b7 -->
...
### CAND-SPRINT-23-F46: `proposal_gate_waiver` field never lived in any template — o
<!-- hash:9f4b9a -->
...
### CAND-SPRINT-23-F47: CLAUDE.md live↔canonical pre-divergent by 4 canonical-only b
<!-- hash:d42a68 -->
...
### CAND-SPRINT-23-F48: `cleargate-planning/MANIFEST.json` SHAs change after every p
<!-- hash:0f1e04 -->
...
### CAND-SPRINT-23-F49: Sprint frontmatter `start_date` is the *planned* date — for 
<!-- hash:c070f1 -->
...
### CAND-SPRINT-23-F50: `protocol-section-N.test.ts` files reference numeric §-IDs t
<!-- hash:efb34c -->
...
### CAND-SPRINT-23-F51: `cleargate wiki lint` exits 1 even for pre-existing findings
<!-- hash:f59c44 -->
...
### CAND-SPRINT-23-F52: M2 citation-rewrite surface omitted `.cleargate/templates/` 
<!-- hash:201390 -->
...
### CAND-SPRINT-23-F53: `git worktree remove --force --force` does NOT kill detached
<!-- hash:0752a2 -->
...
### CAND-SPRINT-23-F54: import.meta.url in vitest source-mode resolves to src/comman
<!-- hash:17b1b6 -->
...
### CAND-SPRINT-23-F55: CLEARGATE_NO_UPDATE_CHECK=1 suppresses all checkLatestVersio
<!-- hash:afbb1f -->
...
### CAND-SPRINT-23-F56: Story bodies authored at SPRINT-N draft time freeze the pack
<!-- hash:67e7b6 -->
...
### CAND-SPRINT-23-F57: cleargate-cli/CHANGELOG.md exists pre-EPIC-016 in non-Common
<!-- hash:02c34b -->
...
### CAND-SPRINT-23-F58: cleargate-cli/src/commands/sync.ts already exists (718 LOC, 
<!-- hash:0fcb8f -->
...
### CAND-SPRINT-23-F59: wiki build reads children: from raw EPIC/SPRINT files (not i
<!-- hash:4d93b6 -->
...
### CAND-SPRINT-23-F60: token-ledger.sh role-grep loop is hard-coded at line 172; ne
<!-- hash:076cff -->
...
### CAND-SPRINT-23-F61: Phase 4 split: TS = deterministic prep (status filter, SHA i
<!-- hash:8b243c -->
...
### CAND-SPRINT-23-F62: assert_story_files.mjs covers all six id shapes (STORY/CR/BU
<!-- hash:949850 -->
...
### CAND-SPRINT-23-F63: update_state.mjs has no module guard — `import { fn } from '
<!-- hash:6a8af4 -->
...
### CAND-SPRINT-23-F64: In bash hook, `DOCTOR_EXIT=$?` after `$(cmd || true)` always
<!-- hash:5af18e -->
...
### CAND-SPRINT-23-F65: Hook resolver tail-branch must never be `exit 0` — use `npx 
<!-- hash:330eae -->
...
### CAND-SPRINT-23-F66: readline.createInterface buffers ahead — when two readline i
<!-- hash:2c1efc -->
...
### CAND-SPRINT-23-F67: startDeviceFlow bump logic: shouldApplyBump=(sleepFn provide
<!-- hash:6d2e18 -->
...
### CAND-SPRINT-23-F68: TS6133 fires when Config is in constructor destructure but n
<!-- hash:27f371 -->
...
### CAND-SPRINT-23-F69: IdentityProvider interface (mcp/src/auth/identity/provider.t
<!-- hash:e330de -->
...
### CAND-SPRINT-23-F70: `identity_proofs.challenge_payload` jsonb is provider-privat
<!-- hash:6cc59b -->
...
### CAND-SPRINT-23-F71: mcp/.env.example documents env vars (e.g. CLEARGATE_RESEND_*
<!-- hash:98add2 -->
...
### CAND-SPRINT-23-F72: drizzle-kit db:generate emits DDL only (no TRUNCATE/DELETE);
<!-- hash:3b88fc -->
...
### CAND-SPRINT-23-F73: wikiBuildHandler returns on success (no exit(0) call); wikiL
<!-- hash:85f301 -->
...
### CAND-SPRINT-23-F74: sprint-archive wrapper is inline in cleargate-cli/src/comman
<!-- hash:ee4230 -->

**Category:** stale
**Reason:** stale: zero grep hits across last 3 sprint dir(s)
**Original entry:** `2026-04-24 · #sprint-archive #file-location · sprint-archive wrapper is inline in cleargate-cli/src/commands/sprint.ts (sprintArchiveHandler at L234 + helpers), NOT cleargate-cli/src/lib/sprint-archive.ts — STORY-015-04 story body cites the wrong path; verify with Glob before editing.`
**Suggested action:** approve to remove via `cleargate flashcard prune` (run /improve)

---

### CAND-SPRINT-23-F75: Rule C fix (sprint→Completed) on pending-sync sprints create
<!-- hash:511450 -->
...
### CAND-SPRINT-23-F76: wiki command tests live at `cleargate-cli/test/wiki/<cmd>.te
<!-- hash:61fc66 -->
...
### CAND-SPRINT-23-F77: sprint/epic/proposal discrimination is via filename prefix t
<!-- hash:6a5501 -->
...
### CAND-SPRINT-23-F78: vitest JSON via --outputFile beats stdout parsing — subproce
<!-- hash:32006b -->
...
### CAND-SPRINT-23-F79: `cleargate sprint close` CLI handler doesn't pass through `-
<!-- hash:893004 -->
...
### CAND-SPRINT-23-F80: `cleargate state update <STORY> <state>` with no --sprint co
<!-- hash:9b3934 -->
...
### CAND-SPRINT-23-F81: close_sprint/suggest_improvements/prefill_report resolve spr
<!-- hash:bb43b2 -->
...
### CAND-SPRINT-23-F82: stories drafted before a prior sprint's protocol edits go st
<!-- hash:27a248 -->
...
### CAND-SPRINT-23-F83: Svelte 5 `$state`/`$derived`/`$effect` don't work in plain `
<!-- hash:6ab1c8 -->
...
### CAND-SPRINT-23-F84: `npm ci --workspace X` skips sibling workspace symlinks; use
<!-- hash:c18ddf -->
...
### CAND-SPRINT-23-F85: SvelteKit endpoints forbid non-HTTP-method named exports; ex
<!-- hash:14cd1e -->
...
### CAND-SPRINT-23-F86: status-of([[ID]]) requires a literal ID — cannot dynamically
<!-- hash:549fdc -->
...
### CAND-SPRINT-23-F87: [R] superseded-by BUG-001-fix · parseFrontmatter must use js
<!-- hash:dc7a29 -->
...
### CAND-SPRINT-23-F88: SubagentStop hook fires on orchestrator session not subagent
<!-- hash:46e9af -->
...
### CAND-SPRINT-23-F89: parallel Developer agents on main share a working tree — one
<!-- hash:dc0a3c -->
...
### CAND-SPRINT-23-F90: [R] superseded-by BUG-001-fix · parseFrontmatter stores nest
<!-- hash:5d3cad -->
...
### CAND-SPRINT-23-F91: init.ts has its own HOOK_ADDITION constant (SPRINT-04 legacy
<!-- hash:5771d2 -->
...
### CAND-SPRINT-23-F92: ManifestEntry.overwrite_policy uses 'skip' not 'never'; stor
<!-- hash:4a7b7d -->
...
### CAND-SPRINT-23-F93: gate check infers transition from cached_gate_result.pass: n
<!-- hash:92b4d1 -->
...
### CAND-SPRINT-23-F94: readiness-gates.md fenced yaml blocks are YAML lists (- work
<!-- hash:c45bf0 -->
...
### CAND-SPRINT-23-F95: section evaluator split on /^(?=## )/m: if body starts with 
<!-- hash:70a9e2 -->
...
### CAND-SPRINT-23-F96: token-ledger.sh routes via `ls -td sprint-runs/*/` and tags 
<!-- hash:f25585 -->
...
### CAND-SPRINT-23-F97: CLAUDE.md bounded-block regex must be GREEDY (`[\s\S]*` not 
<!-- hash:c5c953 -->
...
### CAND-SPRINT-23-F98: open-gates.ts filter `status.includes('🔴')` matches zero it
<!-- hash:5677bc -->
...
### CAND-SPRINT-23-F99: When story body and subagent def disagree on a CLI flag (e.g
<!-- hash:5092e6 -->
...
### CAND-SPRINT-23-F100: Wiki commands (build/ingest) need a `now` test seam to freez
<!-- hash:32caf7 -->
...
### CAND-SPRINT-23-F101: Wiki subagent defs MUST embed exact YAML page-schema templat
<!-- hash:706237 -->
...
### CAND-SPRINT-23-F102: Subagent .md files ship in BOTH cleargate-planning/.claude/a
<!-- hash:3af748 -->
...
### CAND-SPRINT-23-F103: Claude Code hooks schema: PostToolUse uses nested `hooks[]` 
<!-- hash:4eb224 -->
...
### CAND-SPRINT-23-F104: `cleargate join` UUID-first-check pattern: test UUID_V4_RE b
<!-- hash:edbc2e -->
...
### CAND-SPRINT-23-F105: For malformed-UUID path params, validate with regex before D
<!-- hash:f85168 -->
...
### CAND-SPRINT-23-F106: drizzle-kit manual SQL files are ignored by `db:migrate`; al
<!-- hash:ba0f24 -->
...
### CAND-SPRINT-23-F107: vi.mock() is hoisted to top of file; variables used in facto
<!-- hash:b1fd68 -->
...
### CAND-SPRINT-23-F108: When vendoring response schemas in a CLI from a server's han
<!-- hash:4d4efa -->
...
### CAND-SPRINT-23-F109: vi.mock('@napi-rs/keyring') replaces module before native bi
<!-- hash:92a0bf -->
...
### CAND-SPRINT-23-F110: @napi-rs/keyring Entry.getPassword() returns string | null (
<!-- hash:683f9f -->
...
### CAND-SPRINT-23-F111: fs.writeFile(path, data, {mode}) only sets mode on creation;
<!-- hash:183c0d -->
