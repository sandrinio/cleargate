# Improvement Suggestions — SPRINT-26


## Trends

Trends: 15 closed sprints visible — full analysis deferred to CR-027.

## Skill Creation Candidates

<!-- generated-by: suggest_improvements.mjs --skill-candidates -->

### CAND-SPRINT-26-S01: M1 × architect
<!-- hash:b1e420 -->

**Pattern detected:** M1 × architect repeated ≥3× across ≥2 distinct sprints (SPRINT-23, SPRINT-25, SPRINT-26)
...
### CAND-SPRINT-26-F01: QA agent sometimes writes report to worktree-relative `.clea
<!-- hash:ec4b10 -->
...
### CAND-SPRINT-26-F02: Red scenarios for .mjs scripts: invoke via spawnSync(node, [
<!-- hash:00922c -->
...
### CAND-SPRINT-26-F03: pre_gate_runner.sh exits 1 with empty record output (header 
<!-- hash:b13d67 -->
...
### CAND-SPRINT-26-F04: CR-049 named 4 divergent canonical scripts but only 3 actual
<!-- hash:fe9b26 -->
...
### CAND-SPRINT-26-F05: devops subagent type may not register in long Claude Code se
<!-- hash:e00468 -->
...
### CAND-SPRINT-26-F06: run_script.sh interface flip orphaned 6 cleargate-cli/src/co
<!-- hash:db788d -->
...
### CAND-SPRINT-26-F07: For wrapper-interface changes, copy the wrapper into os.tmpd
<!-- hash:bca14e -->
...
### CAND-SPRINT-26-F08: SPRINT-24 orchestrator must explicitly invoke `node update_s
<!-- hash:5588ed -->
...
### CAND-SPRINT-26-F09: SDR HIGH-risk flag on SKILL.md §C anchor proved accurate for
<!-- hash:d03448 -->
...
### CAND-SPRINT-26-F10: `cleargate init --force` overwrites .gitignore + live `.clea
<!-- hash:1a844e -->
...
### CAND-SPRINT-26-F11: wiki/log.md and open-gates.md auto-generated; merge conflict
<!-- hash:8eb505 -->
...
### CAND-SPRINT-26-F12: [R] → superseded-by 2026-05-04/#preflight-doc · preflight St
<!-- hash:dccd72 -->
...
### CAND-SPRINT-26-F13: [S] · token-ledger.sh snapshot-lock supersede pattern: cr-NN
<!-- hash:9c99e0 -->
...
### CAND-SPRINT-26-F14: token-ledger.sh primary dispatch-marker path (L121-141) alre
<!-- hash:dd3120 -->
...
### CAND-SPRINT-26-F15: Sample/example test fixtures live in `cleargate-cli/examples
<!-- hash:559ed8 -->
...
### CAND-SPRINT-26-F16: Red+node combined naming: `*.red.node.test.ts` (red BEFORE n
<!-- hash:8a39c1 -->
...
### CAND-SPRINT-26-F17: SKILL.md §C insert + renumber: forward-only handoff (§C.N fo
<!-- hash:ad69f2 -->
...
### CAND-SPRINT-26-F18: `.claude/hooks/pre-commit-surface-gate.sh` is an 11-line stu
<!-- hash:828c81 -->
...
### CAND-SPRINT-26-F19: NODE_TEST_CONTEXT=child-v8 causes nested tsx --test invocati
<!-- hash:871c6a -->
...
### CAND-SPRINT-26-F20: reporter.md L108 claim "Task tool creates new conversation p
<!-- hash:92fe0a -->
...
### CAND-SPRINT-26-F21: test_close_pipeline reporter.md mirror check fails in worktr
<!-- hash:35e6da -->
...
### CAND-SPRINT-26-F22: close_sprint.mjs Step 3.5 is v2-fatal post-CR-036 — bundle ≥
<!-- hash:0e38f8 -->
...
### CAND-SPRINT-26-F23: Architect plan said close_sprint.mjs is live-only; canonical
<!-- hash:a8602c -->
...
### CAND-SPRINT-26-F24: sprint-v1-legacy fixture had execution_mode:v2 + schema_vers
<!-- hash:baad6b -->
...
### CAND-SPRINT-26-F25: AND-semantics in an enforcing gate means any new required cr
<!-- hash:ae5268 -->
...
### CAND-SPRINT-26-F26: gate.ts or_group?: optional field on GateCriterion — criteri
<!-- hash:e27323 -->
...
### CAND-SPRINT-26-F27: stamp-tokens.ts L194 idKeys array + work-item-type.ts L14 FM
<!-- hash:e33e80 -->
...
### CAND-SPRINT-26-F28: existing-surfaces-verified permissive regex requires file ex
<!-- hash:8fe580 -->
...
### CAND-SPRINT-26-F29: existing-surfaces-verified pass/fail: section absent → pass 
<!-- hash:93868e -->
...
### CAND-SPRINT-26-F30: .session-totals.json is UUID-keyed map not flat — sum Object
<!-- hash:941303 -->
...
### CAND-SPRINT-26-F31: cleargate-planning/.cleargate/scripts/ does NOT mirror prep_
<!-- hash:12203d -->
...
### CAND-SPRINT-26-F32: Live `.claude/agents/` is gitignored — canonical edits to ag
<!-- hash:7deaf6 -->
...
### CAND-SPRINT-26-F33: Step 0 output format must be unconditional: always emit `, N
<!-- hash:76b204 -->
...
### CAND-SPRINT-26-F34: BUG filed against npm-published version may already be fixed
<!-- hash:7364f9 -->
...
### CAND-SPRINT-26-F35: SPRINT-21 cached_gate_result.pass hand-set true (engine can'
<!-- hash:269aeb -->
...
### CAND-SPRINT-26-F36: Tests that grep CLAUDE.md must be updated in the same commit
<!-- hash:97b920 -->
...
### CAND-SPRINT-26-F37: assert_story_files.mjs gained --emit-json flag (CR-027 path-
<!-- hash:5c8281 -->
...
### CAND-SPRINT-26-F38: SDR may name wrong suspect if grep-based; dev bisection can 
<!-- hash:2ab149 -->
...
### CAND-SPRINT-26-F39: backfill_hierarchy.mjs spliceKeys inserted NEW line for exis
<!-- hash:c18ec7 -->
...
### CAND-SPRINT-26-F40: M-plan-spec'd integration test files are REQUIRED, not optio
<!-- hash:0df16d -->
...
### CAND-SPRINT-26-F41: token-ledger.sh has a copy-on-fix snapshot lock in test/snap
<!-- hash:f04670 -->
...
### CAND-SPRINT-26-F42: token-ledger.sh transcript-grep fallback skips ^[0-9]+ items
<!-- hash:adfa5e -->
...
### CAND-SPRINT-26-F43: PreToolUse:Task hook auto-writes dispatch marker by grepping
<!-- hash:21d78b -->
...
### CAND-SPRINT-26-F44: token-ledger.sh uses newest-file lookup (ls -t .dispatch-*.j
<!-- hash:39def5 -->
...
### CAND-SPRINT-26-F45: session-start.sh snapshot locks (cr-008/cr-009) must be upda
<!-- hash:746039 -->
...
### CAND-SPRINT-26-F46: Dev agent's `git commit` landed on `main` instead of `story/
<!-- hash:8c121a -->
...
### CAND-SPRINT-26-F47: Cap forks pool via vitest.config.ts `poolOptions.forks.maxFo
<!-- hash:8c1f83 -->
...
### CAND-SPRINT-26-F48: `cleargate story start <id>` requires CLEARGATE_STATE_FILE e
<!-- hash:f33efe -->
...
### CAND-SPRINT-26-F49: cleargate-cli/templates/cleargate-planning/ is DERIVED — cop
<!-- hash:c25e90 -->
...
### CAND-SPRINT-26-F50: CLAUDE.md live↔canonical pre-divergent by 4 canonical-only b
<!-- hash:d42a68 -->
...
### CAND-SPRINT-26-F51: `cleargate-planning/MANIFEST.json` SHAs change after every p
<!-- hash:0f1e04 -->
...
### CAND-SPRINT-26-F52: Sprint frontmatter `start_date` is the *planned* date — for 
<!-- hash:c070f1 -->
...
### CAND-SPRINT-26-F53: `protocol-section-N.test.ts` files reference numeric §-IDs t
<!-- hash:efb34c -->
...
### CAND-SPRINT-26-F54: `cleargate wiki lint` exits 1 even for pre-existing findings
<!-- hash:f59c44 -->
...
### CAND-SPRINT-26-F55: M2 citation-rewrite surface omitted `.cleargate/templates/` 
<!-- hash:201390 -->
...
### CAND-SPRINT-26-F56: import.meta.url in vitest source-mode resolves to src/comman
<!-- hash:17b1b6 -->
...
### CAND-SPRINT-26-F57: CLEARGATE_NO_UPDATE_CHECK=1 suppresses all checkLatestVersio
<!-- hash:afbb1f -->
...
### CAND-SPRINT-26-F58: Story bodies authored at SPRINT-N draft time freeze the pack
<!-- hash:67e7b6 -->
...
### CAND-SPRINT-26-F59: cleargate-cli/CHANGELOG.md exists pre-EPIC-016 in non-Common
<!-- hash:02c34b -->
...
### CAND-SPRINT-26-F60: cleargate-cli/src/commands/sync.ts already exists (718 LOC, 
<!-- hash:0fcb8f -->
...
### CAND-SPRINT-26-F61: wiki build reads children: from raw EPIC/SPRINT files (not i
<!-- hash:4d93b6 -->
...
### CAND-SPRINT-26-F62: BUG-018 missed the no-force-skip branch; every skip branch t
<!-- hash:95a4c1 -->
...
### CAND-SPRINT-26-F63: token-ledger.sh role-grep loop is hard-coded at line 172; ne
<!-- hash:076cff -->
...
### CAND-SPRINT-26-F64: assert_story_files.mjs covers all six id shapes (STORY/CR/BU
<!-- hash:949850 -->
...
### CAND-SPRINT-26-F65: update_state.mjs has no module guard — `import { fn } from '
<!-- hash:6a8af4 -->
...
### CAND-SPRINT-26-F66: In bash hook, `DOCTOR_EXIT=$?` after `$(cmd || true)` always
<!-- hash:5af18e -->
...
### CAND-SPRINT-26-F67: readline.createInterface buffers ahead — when two readline i
<!-- hash:2c1efc -->
...
### CAND-SPRINT-26-F68: `identity_proofs.challenge_payload` jsonb is provider-privat
<!-- hash:6cc59b -->
...
### CAND-SPRINT-26-F69: mcp/.env.example documents env vars (e.g. CLEARGATE_RESEND_*
<!-- hash:98add2 -->
...
### CAND-SPRINT-26-F70: skip wiki build+lint in sprintArchiveHandler when `.cleargat
<!-- hash:f34f08 -->
...
### CAND-SPRINT-26-F71: wiki command tests live at `cleargate-cli/test/wiki/<cmd>.te
<!-- hash:61fc66 -->
...
### CAND-SPRINT-26-F72: sprint/epic/proposal discrimination is via filename prefix t
<!-- hash:6a5501 -->
...
### CAND-SPRINT-26-F73: `cleargate sprint close` CLI handler doesn't pass through `-
<!-- hash:893004 -->
...
### CAND-SPRINT-26-F74: `cleargate state update <STORY> <state>` with no --sprint co
<!-- hash:9b3934 -->
...
### CAND-SPRINT-26-F75: close_sprint/suggest_improvements/prefill_report resolve spr
<!-- hash:bb43b2 -->
...
### CAND-SPRINT-26-F76: stories drafted before a prior sprint's protocol edits go st
<!-- hash:27a248 -->
...
### CAND-SPRINT-26-F77: exit seam throws in tests; if the throw propagates into `cat
<!-- hash:ece82a -->
...
### CAND-SPRINT-26-F78: `npm ci --workspace X` skips sibling workspace symlinks; use
<!-- hash:c18ddf -->
...
### CAND-SPRINT-26-F79: status-of([[ID]]) requires a literal ID — cannot dynamically
<!-- hash:549fdc -->
...
### CAND-SPRINT-26-F80: parseFrontmatter strips one leading blank line from body; st
<!-- hash:6eebe5 -->
...
### CAND-SPRINT-26-F81: [R] superseded-by BUG-001-fix · parseFrontmatter must use js
<!-- hash:dc7a29 -->
...
### CAND-SPRINT-26-F82: SubagentStop hook fires on orchestrator session not subagent
<!-- hash:46e9af -->
...
### CAND-SPRINT-26-F83: parallel Developer agents on main share a working tree — one
<!-- hash:dc0a3c -->
...
### CAND-SPRINT-26-F84: [R] superseded-by BUG-001-fix · parseFrontmatter stores nest
<!-- hash:5d3cad -->
...
### CAND-SPRINT-26-F85: init.ts has its own HOOK_ADDITION constant (SPRINT-04 legacy
<!-- hash:5771d2 -->
...
### CAND-SPRINT-26-F86: ManifestEntry.overwrite_policy uses 'skip' not 'never'; stor
<!-- hash:4a7b7d -->
...
### CAND-SPRINT-26-F87: gate check infers transition from cached_gate_result.pass: n
<!-- hash:92b4d1 -->
...
### CAND-SPRINT-26-F88: readiness-gates.md fenced yaml blocks are YAML lists (- work
<!-- hash:c45bf0 -->
...
### CAND-SPRINT-26-F89: section evaluator split on /^(?=## )/m: if body starts with 
<!-- hash:70a9e2 -->
...
### CAND-SPRINT-26-F90: token-ledger.sh routes via `ls -td sprint-runs/*/` and tags 
<!-- hash:f25585 -->
...
### CAND-SPRINT-26-F91: CLAUDE.md bounded-block regex must be GREEDY (`[\s\S]*` not 
<!-- hash:c5c953 -->
...
### CAND-SPRINT-26-F92: open-gates.ts filter `status.includes('🔴')` matches zero it
<!-- hash:5677bc -->
...
### CAND-SPRINT-26-F93: Wiki commands (build/ingest) need a `now` test seam to freez
<!-- hash:32caf7 -->
...
### CAND-SPRINT-26-F94: Wiki subagent defs MUST embed exact YAML page-schema templat
<!-- hash:706237 -->
...
### CAND-SPRINT-26-F95: Subagent .md files ship in BOTH cleargate-planning/.claude/a
<!-- hash:3af748 -->
...
### CAND-SPRINT-26-F96: `cleargate join` UUID-first-check pattern: test UUID_V4_RE b
<!-- hash:edbc2e -->
...
### CAND-SPRINT-26-F97: For malformed-UUID path params, validate with regex before D
<!-- hash:f85168 -->
...
### CAND-SPRINT-26-F98: vi.mock() is hoisted to top of file; variables used in facto
<!-- hash:b1fd68 -->
...
### CAND-SPRINT-26-F99: Adopt npm workspaces only when first cross-package import la
<!-- hash:eaef61 -->
...
### CAND-SPRINT-26-F100: vi.mock('@napi-rs/keyring') replaces module before native bi
<!-- hash:92a0bf -->
...
### CAND-SPRINT-26-F101: @napi-rs/keyring Entry.getPassword() returns string | null (
<!-- hash:683f9f -->
...
### CAND-SPRINT-26-F102: fs.writeFile(path, data, {mode}) only sets mode on creation;
<!-- hash:183c0d -->
