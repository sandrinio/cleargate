# Improvement Suggestions — SPRINT-35


## Trends

Trends: 22 closed sprints visible — full analysis deferred to CR-027.
...
### CAND-SPRINT-35-F01: Cross-repo sprint (code in a separate gitignored repo): expo
<!-- hash:690706 -->
...
### CAND-SPRINT-35-F02: broker server.ts boots gateway+registry but does NOT attach 
<!-- hash:7a5540 -->
...
### CAND-SPRINT-35-F03: broker `router.red` "no-cross-talk" test is intermittently f
<!-- hash:fbe712 -->
...
### CAND-SPRINT-35-F04: No-hang E2E rule: probe `claude` ONCE at suite start with a 
<!-- hash:7721ca -->
...
### CAND-SPRINT-35-F05: Two concurrent same-tick app→connector WS sends can coalesce
<!-- hash:0fe173 -->
...
### CAND-SPRINT-35-F06: IEEE-754 sentinel (MAX_SAFE_INTEGER+1) coerces at JS assignm
<!-- hash:3aed97 -->
...
### CAND-SPRINT-35-F07: EOF is the SOLE turn terminus: a `result` → turn_result and 
<!-- hash:a800cd -->
...
### CAND-SPRINT-35-F08: Two disjoint error classes: in-band `is_error:true` → turn_r
<!-- hash:5c7ec4 -->
...
### CAND-SPRINT-35-F09: claude tool names arrive already-PascalCase from the assista
<!-- hash:8d5358 -->
...
### CAND-SPRINT-35-F10: exactOptionalPropertyTypes=true: never assign `prop: expr|un
<!-- hash:9b5f08 -->
...
### CAND-SPRINT-35-F11: Build the `shared` package (npm run build --workspace=shared
<!-- hash:b2ec9e -->
...
### CAND-SPRINT-35-F12: Node 25: `--input-type=module` is stdin/`--eval`/`--print` o
<!-- hash:a25503 -->
...
### CAND-SPRINT-35-F13: Broker presence uses ONE setInterval sweep over a lastSeen/l
<!-- hash:a05279 -->
...
### CAND-SPRINT-35-F14: connector broker/daemon test scripts glob both src/** and te
<!-- hash:6a9896 -->
...
### CAND-SPRINT-35-F15: Developer makes the FROZEN *.red.node.test.ts pass — do NOT 
<!-- hash:73170e -->
...
### CAND-SPRINT-35-F16: Error subclass carrying `cause`: pass via `super(msg, { caus
<!-- hash:592d44 -->
...
### CAND-SPRINT-35-F17: Cross-repo sprint (code in a separate gitignored repo): QA/D
<!-- hash:8a029e -->
...
### CAND-SPRINT-35-F18: A red test that greps for "zero hits" of a token will SELF-H
<!-- hash:bea9ae -->
...
### CAND-SPRINT-35-F19: Running `npm test` via `bash run_script.sh npm test` leaks `
<!-- hash:f5495e -->
...
### CAND-SPRINT-35-F20: cleargate init reads ROOT templates/cleargate-planning (reso
<!-- hash:5e8752 -->
...
### CAND-SPRINT-35-F21: cleargate-cli test_ratchet.mjs lives ONLY in OUTER .cleargat
<!-- hash:02f36e -->
...
### CAND-SPRINT-35-F22: TWO files shell 'npm pack --workspace=cleargate-cli': test/c
<!-- hash:76dcd1 -->
...
### CAND-SPRINT-35-F23: `node --test --import tsx/esm` throws ERR_REQUIRE_CYCLE_MODU
<!-- hash:c505bd -->
...
### CAND-SPRINT-35-F24: A Class-3 close_sprint.mjs gate (e.g. deferred_verification,
<!-- hash:51c0f0 -->
...
### CAND-SPRINT-35-F25: A Class-3 pre-gate check wired into pre_gate_runner.sh (e.g.
<!-- hash:d033ac -->
...
### CAND-SPRINT-35-F26: Worktree config provisioning + its stray-env-scan exemption 
<!-- hash:2ff4d8 -->
...
### CAND-SPRINT-35-F27: `npm run <x> --workspace=<pkg>` fails "No workspaces found" 
<!-- hash:6223d1 -->
...
### CAND-SPRINT-35-F28: `X=$(grep -c PAT f || echo 0)` DOUBLES to "0\n0" on zero mat
<!-- hash:0a46f6 -->
...
### CAND-SPRINT-35-F29: pre_gate_runner.sh arch-mode (~L205) runs `cd "$WORKTREE" &&
<!-- hash:038335 -->
...
### CAND-SPRINT-35-F30: write_dispatch.sh guard FIXED (043-09 re-verify): skip requi
<!-- hash:52d742 -->
