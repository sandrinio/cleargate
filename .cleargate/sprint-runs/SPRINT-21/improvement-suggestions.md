# Improvement Suggestions — SPRINT-21


## Trends

Trends: 10 closed sprints visible — full analysis deferred to CR-027.

## Skill Creation Candidates

<!-- generated-by: suggest_improvements.mjs --skill-candidates -->

### CAND-SPRINT-21-S01: STORY-020-02 × architect
<!-- hash:f55a32 -->
...
### CAND-SPRINT-21-F01: CR-039 spike: session_id is shared across orchestrator+subag
<!-- hash:7f971d -->
...
### CAND-SPRINT-21-F02: reporter.md L108 claim "Task tool creates new conversation p
<!-- hash:92fe0a -->
...
### CAND-SPRINT-21-F03: Claude Code Agent/Task tool shares orchestrator session_id —
<!-- hash:b0c159 -->
...
### CAND-SPRINT-21-F04: close_sprint.mjs Step 3.5 is v2-fatal post-CR-036 — bundle ≥
<!-- hash:0e38f8 -->
...
### CAND-SPRINT-21-F05: Reporter token budget: 200k soft warn / 500k hard advisory +
<!-- hash:3b2855 -->
...
### CAND-SPRINT-21-F06: Reporter dispatched in fresh session via write_dispatch.sh s
<!-- hash:506e66 -->
...
### CAND-SPRINT-21-F07: Architect plan said close_sprint.mjs is live-only; canonical
<!-- hash:a8602c -->
...
### CAND-SPRINT-21-F08: Dev's "pre-existing failure count" can be FILE count not TES
<!-- hash:905de2 -->
...
### CAND-SPRINT-21-F09: AND-semantics in an enforcing gate means any new required cr
<!-- hash:ae5268 -->
...
### CAND-SPRINT-21-F10: gate.ts or_group?: optional field on GateCriterion — criteri
<!-- hash:e27323 -->
...
### CAND-SPRINT-21-F11: stamp-tokens.ts L194 idKeys array + work-item-type.ts L14 FM
<!-- hash:e33e80 -->
...
### CAND-SPRINT-21-F12: existing-surfaces-verified permissive regex requires file ex
<!-- hash:8fe580 -->
...
### CAND-SPRINT-21-F13: existing-surfaces-verified pass/fail: section absent → pass 
<!-- hash:93868e -->
...
### CAND-SPRINT-21-F14: .session-totals.json is UUID-keyed map not flat — sum Object
<!-- hash:941303 -->
...
### CAND-SPRINT-21-F15: cleargate-planning/.cleargate/scripts/ does NOT mirror prep_
<!-- hash:12203d -->
...
### CAND-SPRINT-21-F16: Live `.claude/agents/` is gitignored — canonical edits to ag
<!-- hash:7deaf6 -->
...
### CAND-SPRINT-21-F17: stamp-and-gate snapshot locks (cr-008 + cr-009) must be upda
<!-- hash:2a604b -->
...
### CAND-SPRINT-21-F18: BUG filed against npm-published version may already be fixed
<!-- hash:7364f9 -->
...
### CAND-SPRINT-21-F19: CR-034: spec §4.2 ≤2 listed-item count contradicted §3 6-cri
<!-- hash:e82929 -->
...
### CAND-SPRINT-21-F20: sandbox-paths-declared was duplicate section(2) with blast-r
<!-- hash:a44dce -->
...
### CAND-SPRINT-21-F21: declared-item counts table data rows only after a |---| sepa
<!-- hash:94c5b0 -->
...
### CAND-SPRINT-21-F22: SPRINT-21 cached_gate_result.pass hand-set true (engine can'
<!-- hash:269aeb -->
...
### CAND-SPRINT-21-F23: Tests that grep CLAUDE.md must be updated in the same commit
<!-- hash:97b920 -->
...
### CAND-SPRINT-21-F24: CR-028: template numbered headings (## 3.5, ### 1.6) don't m
<!-- hash:d22224 -->
...
### CAND-SPRINT-21-F25: CR-028 SPRINT-20 anchor backfill = 6 anchors get sections (E
<!-- hash:c720c5 -->
...
### CAND-SPRINT-21-F26: CR-028 inserted unnumbered "Code-Truth Principle" preamble B
<!-- hash:42a713 -->
...
### CAND-SPRINT-21-F27: CR-028: code-truth principle stack — wiki/memory/context_sou
<!-- hash:96b1dd -->
...
### CAND-SPRINT-21-F28: CR-027 §4.7: Scenario 14 tests null-gate-result, not risk-ta
<!-- hash:e434b0 -->
...
### CAND-SPRINT-21-F29: CR-027: sprint preflight gained check #5 (per-item cached_ga
<!-- hash:7bd308 -->
...
### CAND-SPRINT-21-F30: assert_story_files.mjs gained --emit-json flag (CR-027 path-
<!-- hash:5c8281 -->
...
### CAND-SPRINT-21-F31: SDR may name wrong suspect if grep-based; dev bisection can 
<!-- hash:2ab149 -->
...
### CAND-SPRINT-21-F32: backfill_hierarchy.mjs spliceKeys inserted NEW line for exis
<!-- hash:c18ec7 -->
...
### CAND-SPRINT-21-F33: M-plan-spec'd integration test files are REQUIRED, not optio
<!-- hash:0df16d -->
...
### CAND-SPRINT-21-F34: token-ledger.sh has a copy-on-fix snapshot lock in test/snap
<!-- hash:f04670 -->
...
### CAND-SPRINT-21-F35: token-ledger.sh transcript-grep fallback skips ^[0-9]+ items
<!-- hash:adfa5e -->
...
### CAND-SPRINT-21-F36: PreToolUse:Task hook auto-writes dispatch marker by grepping
<!-- hash:21d78b -->
...
### CAND-SPRINT-21-F37: token-ledger.sh uses newest-file lookup (ls -t .dispatch-*.j
<!-- hash:39def5 -->
...
### CAND-SPRINT-21-F38: session-start.sh snapshot locks (cr-008/cr-009) must be upda
<!-- hash:746039 -->
...
### CAND-SPRINT-21-F39: Dev agent's `git commit` landed on `main` instead of `story/
<!-- hash:8c121a -->
...
### CAND-SPRINT-21-F40: vitest maxForks cap is PER-PROCESS — N parallel agents × max
<!-- hash:560649 -->
...
### CAND-SPRINT-21-F41: Cap forks pool via vitest.config.ts `poolOptions.forks.maxFo
<!-- hash:8c1f83 -->
...
### CAND-SPRINT-21-F42: `cleargate story start <id>` requires CLEARGATE_STATE_FILE e
<!-- hash:f33efe -->
...
### CAND-SPRINT-21-F43: cleargate-cli/templates/cleargate-planning/ is DERIVED — cop
<!-- hash:c25e90 -->
...
### CAND-SPRINT-21-F44: vitest spawns 5–9 tinypool workers (~4GB each) that survive 
<!-- hash:69c9b7 -->
...
### CAND-SPRINT-21-F45: CLAUDE.md live↔canonical pre-divergent by 4 canonical-only b
<!-- hash:d42a68 -->
...
### CAND-SPRINT-21-F46: `cleargate-planning/MANIFEST.json` SHAs change after every p
<!-- hash:0f1e04 -->
...
### CAND-SPRINT-21-F47: DoD §4.2 specifies `feat(<epic>):` but Developers default to
<!-- hash:9d6184 -->
...
### CAND-SPRINT-21-F48: Multi-phase doc-migration scripts MUST read all source conte
<!-- hash:5abc87 -->
...
### CAND-SPRINT-21-F49: Sprint frontmatter `start_date` is the *planned* date — for 
<!-- hash:c070f1 -->
...
### CAND-SPRINT-21-F50: `protocol-section-N.test.ts` files reference numeric §-IDs t
<!-- hash:efb34c -->
...
### CAND-SPRINT-21-F51: `cleargate wiki lint` exits 1 even for pre-existing findings
<!-- hash:f59c44 -->
...
### CAND-SPRINT-21-F52: M2 citation-rewrite surface omitted `.cleargate/templates/` 
<!-- hash:201390 -->
...
### CAND-SPRINT-21-F53: `git worktree remove --force --force` does NOT kill detached
<!-- hash:0752a2 -->
...
### CAND-SPRINT-21-F54: import.meta.url in vitest source-mode resolves to src/comman
<!-- hash:17b1b6 -->
...
### CAND-SPRINT-21-F55: CLEARGATE_NO_UPDATE_CHECK=1 suppresses all checkLatestVersio
<!-- hash:afbb1f -->
...
### CAND-SPRINT-21-F56: worktrees share no node_modules with parent; run `npm ci --w
<!-- hash:cb754b -->
...
### CAND-SPRINT-21-F57: Story bodies authored at SPRINT-N draft time freeze the pack
<!-- hash:67e7b6 -->
...
### CAND-SPRINT-21-F58: cleargate-cli/CHANGELOG.md exists pre-EPIC-016 in non-Common
<!-- hash:02c34b -->
...
### CAND-SPRINT-21-F59: MCP tool requests must NOT carry project_id in the body — JW
<!-- hash:a2932f -->
...
### CAND-SPRINT-21-F60: CLI sha = sha256(body + serializeFrontmatter(fm)) where seri
<!-- hash:aa1c13 -->
...
### CAND-SPRINT-21-F61: cleargate-cli/src/commands/sync.ts already exists (718 LOC, 
<!-- hash:0fcb8f -->
...
### CAND-SPRINT-21-F62: wiki build reads children: from raw EPIC/SPRINT files (not i
<!-- hash:4d93b6 -->
...
### CAND-SPRINT-21-F63: BUG-018 missed the no-force-skip branch; every skip branch t
<!-- hash:95a4c1 -->
...
### CAND-SPRINT-21-F64: token-ledger.sh role-grep loop is hard-coded at line 172; ne
<!-- hash:076cff -->
...
### CAND-SPRINT-21-F65: Phase 4 split: TS = deterministic prep (status filter, SHA i
<!-- hash:8b243c -->
...
### CAND-SPRINT-21-F66: assert_story_files.mjs covers all six id shapes (STORY/CR/BU
<!-- hash:949850 -->
...
### CAND-SPRINT-21-F67: update_state.mjs has no module guard — `import { fn } from '
<!-- hash:6a8af4 -->
...
### CAND-SPRINT-21-F68: In bash hook, `DOCTOR_EXIT=$?` after `$(cmd || true)` always
<!-- hash:5af18e -->
...
### CAND-SPRINT-21-F69: Hook resolver tail-branch must never be `exit 0` — use `npx 
<!-- hash:330eae -->
...
### CAND-SPRINT-21-F70: readline.createInterface buffers ahead — when two readline i
<!-- hash:2c1efc -->
...
### CAND-SPRINT-21-F71: `identity_proofs.challenge_payload` jsonb is provider-privat
<!-- hash:6cc59b -->
...
### CAND-SPRINT-21-F72: mcp/.env.example documents env vars (e.g. CLEARGATE_RESEND_*
<!-- hash:98add2 -->
...
### CAND-SPRINT-21-F73: worktree npm ci needed for typecheck — node_modules not shar
<!-- hash:20ab4e -->
...
### CAND-SPRINT-21-F74: Rule C fix (sprint→Completed) on pending-sync sprints create
<!-- hash:511450 -->
...
### CAND-SPRINT-21-F75: wiki command tests live at `cleargate-cli/test/wiki/<cmd>.te
<!-- hash:61fc66 -->
...
### CAND-SPRINT-21-F76: sprint/epic/proposal discrimination is via filename prefix t
<!-- hash:6a5501 -->
...
### CAND-SPRINT-21-F77: vitest JSON via --outputFile beats stdout parsing — subproce
<!-- hash:32006b -->
...
### CAND-SPRINT-21-F78: `cleargate sprint close` CLI handler doesn't pass through `-
<!-- hash:893004 -->
...
### CAND-SPRINT-21-F79: `cleargate state update <STORY> <state>` with no --sprint co
<!-- hash:9b3934 -->
...
### CAND-SPRINT-21-F80: close_sprint/suggest_improvements/prefill_report resolve spr
<!-- hash:bb43b2 -->
...
### CAND-SPRINT-21-F81: stories drafted before a prior sprint's protocol edits go st
<!-- hash:27a248 -->
...
### CAND-SPRINT-21-F82: Admin Dockerfile must force ENV NODE_ENV=development in buil
<!-- hash:74cbf0 -->
...
### CAND-SPRINT-21-F83: status-of([[ID]]) requires a literal ID — cannot dynamically
<!-- hash:549fdc -->
...
### CAND-SPRINT-21-F84: [R] superseded-by BUG-001-fix · parseFrontmatter must use js
<!-- hash:dc7a29 -->
...
### CAND-SPRINT-21-F85: parallel Developer agents on main share a working tree — one
<!-- hash:dc0a3c -->
...
### CAND-SPRINT-21-F86: [R] superseded-by BUG-001-fix · parseFrontmatter stores nest
<!-- hash:5d3cad -->
...
### CAND-SPRINT-21-F87: init.ts has its own HOOK_ADDITION constant (SPRINT-04 legacy
<!-- hash:5771d2 -->
...
### CAND-SPRINT-21-F88: ManifestEntry.overwrite_policy uses 'skip' not 'never'; stor
<!-- hash:4a7b7d -->
...
### CAND-SPRINT-21-F89: gate check infers transition from cached_gate_result.pass: n
<!-- hash:92b4d1 -->
...
### CAND-SPRINT-21-F90: readiness-gates.md fenced yaml blocks are YAML lists (- work
<!-- hash:c45bf0 -->
...
### CAND-SPRINT-21-F91: section evaluator split on /^(?=## )/m: if body starts with 
<!-- hash:70a9e2 -->
...
### CAND-SPRINT-21-F92: token-ledger.sh routes via `ls -td sprint-runs/*/` and tags 
<!-- hash:f25585 -->
...
### CAND-SPRINT-21-F93: CLAUDE.md bounded-block regex must be GREEDY (`[\s\S]*` not 
<!-- hash:c5c953 -->
...
### CAND-SPRINT-21-F94: open-gates.ts filter `status.includes('🔴')` matches zero it
<!-- hash:5677bc -->
...
### CAND-SPRINT-21-F95: When story body and subagent def disagree on a CLI flag (e.g
<!-- hash:5092e6 -->
...
### CAND-SPRINT-21-F96: Wiki commands (build/ingest) need a `now` test seam to freez
<!-- hash:32caf7 -->
...
### CAND-SPRINT-21-F97: Wiki subagent defs MUST embed exact YAML page-schema templat
<!-- hash:706237 -->
...
### CAND-SPRINT-21-F98: Claude Code hooks schema: PostToolUse uses nested `hooks[]` 
<!-- hash:4eb224 -->
...
### CAND-SPRINT-21-F99: `cleargate join` UUID-first-check pattern: test UUID_V4_RE b
<!-- hash:edbc2e -->
...
### CAND-SPRINT-21-F100: For malformed-UUID path params, validate with regex before D
<!-- hash:f85168 -->
...
### CAND-SPRINT-21-F101: vi.mock() is hoisted to top of file; variables used in facto
<!-- hash:b1fd68 -->
...
### CAND-SPRINT-21-F102: When vendoring response schemas in a CLI from a server's han
<!-- hash:4d4efa -->
...
### CAND-SPRINT-21-F103: Admin JWT file ~/.cleargate/admin-auth.json is a single-toke
<!-- hash:3be8f5 -->
...
### CAND-SPRINT-21-F104: vi.mock('@napi-rs/keyring') replaces module before native bi
<!-- hash:92a0bf -->
...
### CAND-SPRINT-21-F105: @napi-rs/keyring Entry.getPassword() returns string | null (
<!-- hash:683f9f -->
...
### CAND-SPRINT-21-F106: fs.writeFile(path, data, {mode}) only sets mode on creation;
<!-- hash:183c0d -->
