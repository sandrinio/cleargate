...
draft_tokens:
  ...
  cache_read: null
  model: null
  last_stamp: 2026-06-02T10:12:49Z
  sessions: []
---
...
- [ ] `approved: true` is set in the YAML frontmatter. — *Intentionally Draft. Owner directed filing; approval is a separate Gate-1 step pending the §0.5 decisions.*
