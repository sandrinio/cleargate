...
| [`CR-019`](CR-019_Sprint_Close_Requires_Explicit_Human_Ack.md) | CR | Sprint close requires explicit human ack — orchestrator MUST NOT pass `--assume-ack`; protocol §12 + CLAUDE.md guardrail + `close_sprint.mjs` usage doc | fast | L1 | y | low | M0 |
