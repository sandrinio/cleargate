...
describe('Scenario: --session-start emits pre-member banner', () => {
  test('first line is the pre-member banner when no auth file is present', async () => {
  ...
  test('first line is the pre-member banner when JWT is expired', async () => {
    const dir = makeTmpDir();
    const cwd = dir;
...
describe('Scenario: --session-start emits member banner', () => {
  test('first line is the member banner with project_id when JWT is valid', async () => {
    const dir = makeTmpDir();
    const cwd = dir;
    const home = path.join(dir, '.cleargate');
  ...
  test('banner precedes the resolver-status line (is the first line)', async () => {
    const dir = makeTmpDir();
    const cwd = dir;
    const home = path.join(dir, '.cleargate');
