...
// node:test mock.module() uses { namedExports: {...} } not a factory function
...
class MockEntry {
  ...
  setPassword(password: string): void {
    keychainStore.set(this.key, password);
  }
  getPassword(): string | null {
    return keychainStore.get(this.key) ?? null;
  }
  deletePassword(): boolean {
    return keychainStore.delete(this.key);
  }
}

await mock.module('@napi-rs/keyring', { namedExports: { Entry: MockEntry } });
...
describe('KeychainTokenStore (mocked @napi-rs/keyring)', () => {
  ...
  test('Test 12: save/load round-trips token via mocked Entry', async () => {
  ...
  test('Test 13: getPassword returning null surfaces as null from load', async () => {
  ...
  test('Test 14: remove on missing profile does not throw', async () => {
