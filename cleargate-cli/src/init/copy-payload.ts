 ...
 *
 * - MANIFEST.json (CR-053): payload-root MANIFEST.json is a meta-repo build
 *   artifact (generated by `npm run prebuild` to verify payload integrity).
 *   It must NOT be written to user-repo roots; its canonical location is
 *   `cleargate-planning/MANIFEST.json` (inside the planning subdir, tracked).
 */
